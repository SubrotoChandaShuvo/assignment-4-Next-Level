...
config.runtimeDataModel = JSON.parse("{\"models\":{\"Car\":{\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"type\":\"Int\"},{\"name\":\"name\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"mode\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"year\",\"kind\":\"scalar\",\"type\":\"Int\"}],\"dbName\":null}},\"enums\":{},\"types\":{}}")
config.parameterizationSchema = {
  strings: JSON.parse("[\"where\",\"Car.findUnique\",\"Car.findUniqueOrThrow\",\"orderBy\",\"cursor\",\"Car.findFirst\",\"Car.findFirstOrThrow\",\"Car.findMany\",\"data\",\"Car.createOne\",\"Car.createMany\",\"Car.createManyAndReturn\",\"Car.updateOne\",\"Car.updateMany\",\"Car.updateManyAndReturn\",\"create\",\"update\",\"Car.upsertOne\",\"Car.deleteOne\",\"Car.deleteMany\",\"having\",\"_count\",\"_avg\",\"_sum\",\"_min\",\"_max\",\"Car.groupBy\",\"Car.aggregate\",\"AND\",\"OR\",\"NOT\",\"id\",\"name\",\"mode\",\"year\",\"equals\",\"in\",\"notIn\",\"lt\",\"lte\",\"gt\",\"gte\",\"contains\",\"startsWith\",\"endsWith\",\"not\",\"set\",\"increment\",\"decrement\",\"multiply\",\"divide\"]"),
